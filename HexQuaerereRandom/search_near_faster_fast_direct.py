            ...
            if all(byte != "00" for byte in segment) and \
               ...
               all(byte != "80" for byte in segment):
                if segment in unique_segments:
                    ...
                    successful_matches.append((line1_idx + 1, ram_address1, matched_bytes))
                    print(f"    Match found: Pairs1 Line {line1_idx + 1}, RAM Address 0x{ram_address1:05x}, Matched Bytes: {matched_bytes}")
